...
def get_COLLECTION_docs_urls() -> List[str]:
    """Get URLs from COLLECTION docs sitemap."""
    sitemap_url = "{url-here}/sitemap.xml"
    local_sitemap_path = "./COLLECTION_sitemap.xml"  # Update with the actual path to your local sitemap.xml
